    ...
    SubShader {
        Pass {
            ...
            v2f vert (a2v i) {
                ...
                o.lightDir = mul (worldToTangent, WorldSpaceLightDir(i.vertex));                
                // Transform the view direction from object space to tangent space
                o.viewDir = mul (worldToTangent, WorldSpaceViewDir(i.vertex));
            ...
            fixed4 frag (v2f i) : SV_Target {
                ...
                // tangentNormal.z = sqrt (1.0 - saturate (dot (tangentNormal.xy, tangentNormal.xy)));  // 手動算出z軸，因為是單位向量
